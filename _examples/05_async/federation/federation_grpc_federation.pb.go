...
func (s *FederationService) resolve_Org_Federation_GetResponse(ctx context.Context, req *Org_Federation_GetResponseArgument[*FederationServiceDependentClientSet]) (*GetResponse, error) {
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		grpcfed.GoWithRecover(eg, func() (any, error) {
			...
			grpcfed.GoWithRecover(eg, func() (any, error) {
				...
				*/
				{
					valueIface, err, _ := sg.Do("a_org.federation.A", func() (any, error) {
						valueMu.RLock()
				...
				*/
				{
					valueIface, err, _ := sg.Do("c_org.federation.C", func() (any, error) {
						valueMu.RLock()
			...
			grpcfed.GoWithRecover(eg, func() (any, error) {
				...
				*/
				{
					valueIface, err, _ := sg.Do("b_org.federation.B", func() (any, error) {
						valueMu.RLock()
				...
				*/
				{
					valueIface, err, _ := sg.Do("d_org.federation.D", func() (any, error) {
						valueMu.RLock()
			...
			*/
			{
				valueIface, err, _ := sg.Do("e_org.federation.E", func() (any, error) {
					valueMu.RLock()
		...
		grpcfed.GoWithRecover(eg, func() (any, error) {
			...
			*/
			{
				valueIface, err, _ := sg.Do("f_org.federation.F", func() (any, error) {
					valueMu.RLock()
		...
		grpcfed.GoWithRecover(eg, func() (any, error) {
			...
			*/
			{
				valueIface, err, _ := sg.Do("g_org.federation.G", func() (any, error) {
					valueMu.RLock()
		...
		*/
		{
			valueIface, err, _ := sg.Do("h_org.federation.H", func() (any, error) {
				valueMu.RLock()
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		{
			valueIface, err, _ := sg.Do("i_org.federation.I", func() (any, error) {
				valueMu.RLock()
		...
		*/
		{
			valueIface, err, _ := sg.Do("j_org.federation.J", func() (any, error) {
				valueMu.RLock()
