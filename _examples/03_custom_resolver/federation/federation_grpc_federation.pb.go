...
func (s *FederationService) resolve_Federation_Post(ctx context.Context, req *Federation_PostArgument[*FederationServiceDependentClientSet]) (*Post, error) {
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		resForNamelessIface, err, _ := sg.Do("_federation_ForNameless_federation.ForNameless", func() (any, error) {
			valueMu.RLock()
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		resUnusedIface, err, _ := sg.Do("unused_federation.Unused", func() (any, error) {
			valueMu.RLock()
