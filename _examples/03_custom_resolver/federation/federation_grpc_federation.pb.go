...
// Federation_V2Dev_TypedNullArgument is argument for "federation.v2dev.TypedNull" message.
type FederationV2DevService_Federation_V2Dev_TypedNullArgument struct {
}
...
type FederationV2DevServiceResolver interface {
	...
	// Resolve_Federation_V2Dev_TypedNull implements resolver for "federation.v2dev.TypedNull".
	Resolve_Federation_V2Dev_TypedNull(context.Context, *FederationV2DevService_Federation_V2Dev_TypedNullArgument) (*TypedNull, error)
...
// Resolve_Federation_V2Dev_TypedNull resolve "federation.v2dev.TypedNull".
// This method always returns Unimplemented error.
func (FederationV2DevServiceUnimplementedResolver) Resolve_Federation_V2Dev_TypedNull(context.Context, *FederationV2DevService_Federation_V2Dev_TypedNullArgument) (ret *TypedNull, e error) {
	e = grpcfed.GRPCErrorf(grpcfed.UnimplementedCode, "method Resolve_Federation_V2Dev_TypedNull not implemented")
	return
}
...
func NewFederationV2DevService(cfg FederationV2DevServiceConfig) (*FederationV2DevService, error) {
	...
	celTypeHelperFieldMap := grpcfed.CELTypeHelperFieldMap{
		...
		"grpc.federation.private.TypedNullArgument": {},
...
func (s *FederationV2DevService) resolve_Federation_V2Dev_PostV2Dev(ctx context.Context, req *FederationV2DevService_Federation_V2Dev_PostV2DevArgument) (*PostV2Dev, error) {
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		if err := grpcfed.EvalDef(ctx1, value, grpcfed.Def[*TypedNull, *localValueType]{
			Name: `typed_null`,
			Type: grpcfed.CELObjectType("federation.v2dev.TypedNull"),
			Setter: func(value *localValueType, v *TypedNull) error {
				value.vars.typed_null = v
				return nil
			},
			Message: func(ctx context.Context, value *localValueType) (any, error) {
				args := &FederationV2DevService_Federation_V2Dev_TypedNullArgument{}
				ret, err := s.resolve_Federation_V2Dev_TypedNull(ctx, args)
				if err != nil {
					return nil, err
				}
				return ret, nil
	...
	req.TypedNull = value.vars.typed_null
...
// resolve_Federation_V2Dev_TypedNull resolve "federation.v2dev.TypedNull" message.
func (s *FederationV2DevService) resolve_Federation_V2Dev_TypedNull(ctx context.Context, req *FederationV2DevService_Federation_V2Dev_TypedNullArgument) (*TypedNull, error) {
	ctx, span := s.tracer.Start(ctx, "federation.v2dev.TypedNull")
	defer span.End()
	ctx = grpcfed.WithLogger(ctx, grpcfed.Logger(ctx), grpcfed.LogAttrs(ctx)...)

	grpcfed.Logger(ctx).DebugContext(ctx, "resolve federation.v2dev.TypedNull", slog.Any("message_args", s.logvalue_Federation_V2Dev_TypedNullArgument(req)))

	// create a message value to be returned.
	// `custom_resolver = true` in "grpc.federation.message" option.
	ctx = grpcfed.WithLogger(ctx, grpcfed.Logger(ctx)) // create a new reference to logger.
	ret, err := s.resolver.Resolve_Federation_V2Dev_TypedNull(ctx, req)
	if err != nil {
		grpcfed.RecordErrorToSpan(ctx, err)
		return nil, err
	}

	grpcfed.Logger(ctx).DebugContext(ctx, "resolved federation.v2dev.TypedNull", slog.Any("federation.v2dev.TypedNull", s.logvalue_Federation_V2Dev_TypedNull(ret)))
	return ret, nil
}
...
func (s *FederationV2DevService) logvalue_Federation_V2Dev_TypedNull(v *TypedNull) slog.Value {
	if v == nil {
		return slog.GroupValue()
	}
	return slog.GroupValue()
...
func (s *FederationV2DevService) logvalue_Federation_V2Dev_TypedNullArgument(v *FederationV2DevService_Federation_V2Dev_TypedNullArgument) slog.Value {
	if v == nil {
		return slog.GroupValue()
	}
	return slog.GroupValue()
