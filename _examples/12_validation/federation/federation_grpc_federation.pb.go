	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		grpcfed.GoWithRecover(eg, func() (any, error) {
			...
			*/
			if err := grpcfed.EvalDef(ctx2, value, grpcfed.Def[*Post, *localValueType]{
				Name: `post`,
			...
			*/
			if err := grpcfed.EvalDef(ctx2, value, grpcfed.Def[bool, *localValueType]{
				Name: `_def2`,
				Type: grpcfed.CELBoolType,
				Setter: func(value *localValueType, v bool) error {
					value.vars._def2 = v
				...
				Validation: func(ctx context.Context, value *localValueType) error {
					var stat *grpcfed.Status
					if err := grpcfed.If(ctx2, &grpcfed.IfParam[*localValueType]{
						Value:      value,
		...
		grpcfed.GoWithRecover(eg, func() (any, error) {
			...
			grpcfed.GoWithRecover(eg, func() (any, error) {
				...
				*/
				if err := grpcfed.EvalDef(ctx3, value, grpcfed.Def[*Post, *localValueType]{
					Name: `post`,
					Type: grpcfed.CELObjectType("org.federation.Post"),
					Setter: func(value *localValueType, v *Post) error {
						value.vars.post = v
				...
				*/
				if err := grpcfed.EvalDef(ctx3, value, grpcfed.Def[bool, *localValueType]{
					Name: `_def2`,
					Type: grpcfed.CELBoolType,
					Setter: func(value *localValueType, v bool) error {
						value.vars._def2 = v
					...
					Validation: func(ctx context.Context, value *localValueType) error {
						var stat *grpcfed.Status
						if err := grpcfed.If(ctx3, &grpcfed.IfParam[*localValueType]{
							Value:      value,
							Expr:       `post.id != 'some-id'`,
							CacheIndex: 5,
							Body: func(value *localValueType) error {
		...
		grpcfed.GoWithRecover(eg, func() (any, error) {
			...
			grpcfed.GoWithRecover(eg, func() (any, error) {
				...
				grpcfed.GoWithRecover(eg, func() (any, error) {
					...
					*/
					if err := grpcfed.EvalDef(ctx4, value, grpcfed.Def[*Post, *localValueType]{
						Name: `post`,
						Type: grpcfed.CELObjectType("org.federation.Post"),
						Setter: func(value *localValueType, v *Post) error {
							value.vars.post = v
					...
					*/
					if err := grpcfed.EvalDef(ctx4, value, grpcfed.Def[bool, *localValueType]{
						Name: `_def2`,
						Type: grpcfed.CELBoolType,
						Setter: func(value *localValueType, v bool) error {
							value.vars._def2 = v
						...
						Validation: func(ctx context.Context, value *localValueType) error {
							var stat *grpcfed.Status
							if err := grpcfed.If(ctx4, &grpcfed.IfParam[*localValueType]{
								Value:      value,
								Expr:       `post.id != 'some-id'`,
								CacheIndex: 11,
								Body: func(value *localValueType) error {
						...
						Body: func(value *localValueType) error {
							...
							if err := grpcfed.If(ctx2, &grpcfed.IfParam[*localValueType]{
								...
								Body: func(value *localValueType) error {
									...
									if detail := grpcfed.CustomMessage(ctx2, &grpcfed.CustomMessageParam{
										Value:            value,
							...
							if err != nil {
								grpcfed.Logger(ctx2).ErrorContext(ctx2, "failed setting error details", slog.String("error", err.Error()))
								stat = status
							} else {
