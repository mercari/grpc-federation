		...
		if _, err, _ := sg.Do("_def0", func() (any, error) {
			{
				err := func() error {
					valueMu.RLock()
					value, err := grpcfed.EvalCEL(ctx, s.env, "$.arg == 'wrong'", envOpts, evalValues, reflect.TypeOf(false))
					valueMu.RUnlock()
					if err != nil {
						return err
					}
...
func (s *FederationService) resolve_Org_Federation_CustomMessage(ctx context.Context, req *Org_Federation_CustomMessageArgument[*FederationServiceDependentClientSet]) (*CustomMessage, error) {
	...
	envOpts := []cel.EnvOption{cel.Variable(grpcfed.MessageArgumentVariableName, cel.ObjectType("grpc.federation.private.CustomMessageArgument"))}
	evalValues := map[string]any{grpcfed.MessageArgumentVariableName: req}
			...
			if _, err, _ := sg.Do("_def4", func() (any, error) {
				{
					err := func() error {
						...
						{
							valueMu.RLock()
							value, err := grpcfed.EvalCEL(ctx, s.env, "$.id != 'correct-id'", envOpts, evalValues, reflect.TypeOf(false))
							valueMu.RUnlock()
							if err != nil {
								return err
							}
							if value.(bool) {
								...
								func() {
									...
									func() {
										msg, err := grpcfed.EvalCEL(ctx, s.env, "_def4_err_detail0_msg0", envOpts, evalValues, reflect.TypeOf((proto.Message)(nil)))
										if err != nil {
									...
									func() {
										msg, err := grpcfed.EvalCEL(ctx, s.env, "_def4_err_detail0_msg1", envOpts, evalValues, reflect.TypeOf((proto.Message)(nil)))
										if err != nil {
								...
								}()
								{
									var violations []*errdetails.PreconditionFailure_Violation
									{
										func() {
											valueMu.RLock()
											typ, err := grpcfed.EvalCEL(ctx, s.env, "'type1'", envOpts, evalValues, reflect.TypeOf(""))
											valueMu.RUnlock()
											if err != nil {
											...
											valueMu.RLock()
											subject, err := grpcfed.EvalCEL(ctx, s.env, "post.id", envOpts, evalValues, reflect.TypeOf(""))
											valueMu.RUnlock()
											if err != nil {
											...
											valueMu.RLock()
											description, err := grpcfed.EvalCEL(ctx, s.env, "'description1'", envOpts, evalValues, reflect.TypeOf(""))
											valueMu.RUnlock()
											if err != nil {
								...
								}
								{
									var violations []*errdetails.BadRequest_FieldViolation
									{
										func() {
											valueMu.RLock()
											field, err := grpcfed.EvalCEL(ctx, s.env, "post.id", envOpts, evalValues, reflect.TypeOf(""))
											valueMu.RUnlock()
											if err != nil {
											...
											valueMu.RLock()
											description, err := grpcfed.EvalCEL(ctx, s.env, "'description2'", envOpts, evalValues, reflect.TypeOf(""))
											valueMu.RUnlock()
											if err != nil {
								...
								}
								{
									func() {
										valueMu.RLock()
										message, err := grpcfed.EvalCEL(ctx, s.env, "post.content", envOpts, evalValues, reflect.TypeOf(""))
										valueMu.RUnlock()
										if err != nil {
