...
func (s *FederationService) resolve_Org_Federation_CustomHandlerMessage(ctx context.Context, req *Org_Federation_CustomHandlerMessageArgument[*FederationServiceDependentClientSet]) (*CustomHandlerMessage, error) {
	...
	value := &localValueType{LocalValue: grpcfed.NewLocalValue(s.env, "grpc.federation.private.CustomHandlerMessageArgument", req)}
		...
		*/
		if err := grpcfed.EvalDef(ctx1, value, grpcfed.Def[bool, *localValueType]{
			...
			Validation: func(ctx context.Context, value *localValueType) error {
				...
				return grpcfed.If(ctx, value, "true", func(value *localValueType) error {
					if err := grpcfed.If(ctx, value, "$.id != 'correct-id'", func(value *localValueType) error {
						...
						func() {
							...
							if detail := grpcfed.CustomMessage(ctx, value, "_def4_err_detail0_msg0", 0); detail != nil {
								details = append(details, detail)
							}
							if detail := grpcfed.CustomMessage(ctx, value, "_def4_err_detail0_msg1", 1); detail != nil {
								details = append(details, detail)
							}
						}()
						...
						if detail := grpcfed.LocalizedMessage(ctx, value, "en-US", "post.content"); detail != nil {
							details = append(details, detail)
						}
						return nil
					}); err != nil {
