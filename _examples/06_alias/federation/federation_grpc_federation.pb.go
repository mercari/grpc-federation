...
func (s *FederationService) resolve_Org_Federation_GetPostResponse(ctx context.Context, req *Org_Federation_GetPostResponseArgument) (*GetPostResponse, error) {
	...
	type localValueType struct {
		*grpcfed.LocalValue
		vars struct {
			cond_a *GetPostRequest_ConditionA
			post   *Post
		}
	}
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		if err := grpcfed.EvalDef(ctx1, value, grpcfed.Def[*GetPostRequest_ConditionA, *localValueType]{
			Name: `cond_a`,
			Type: grpcfed.CELObjectType("org.federation.GetPostRequest.ConditionA"),
			Setter: func(value *localValueType, v *GetPostRequest_ConditionA) error {
				value.vars.cond_a = v
				return nil
			},
			By:                  `$.a`,
