...
var file_federation_federation_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xd9, 0x0e, 0x0a, 0x0f, 0x47,
	...
	0x72, 0x74, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x3a, 0xea, 0x04, 0x9a, 0x4a, 0xe6, 0x04,
	0x0a, 0x1a, 0x0a, 0x04, 0x70, 0x6f, 0x73, 0x74, 0x6a, 0x12, 0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74,
	0x12, 0x0a, 0x0a, 0x02, 0x69, 0x64, 0x12, 0x04, 0x24, 0x2e, 0x69, 0x64, 0x0a, 0x59, 0x0a, 0x04,
	...
	0x27, 0x41, 0x73, 0x69, 0x61, 0x2f, 0x54, 0x6f, 0x6b, 0x79, 0x6f, 0x27, 0x29, 0x0a, 0x38, 0x0a,
	...
	0x61, 0x64, 0x64, 0x72, 0x31, 0x29, 0x22, 0x86, 0x02, 0x0a, 0x01, 0x41, 0x12, 0x25, 0x0a, 0x01,
	...
	0x52, 0x01, 0x62, 0x1a, 0xc8, 0x01, 0x0a, 0x01, 0x42, 0x12, 0x2d, 0x0a, 0x03, 0x66, 0x6f, 0x6f,
	...
	0x06, 0x24, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x3a, 0x3f, 0x9a,
	0x4a, 0x3c, 0x0a, 0x1c, 0x0a, 0x03, 0x66, 0x6f, 0x6f, 0x6a, 0x15, 0x0a, 0x05, 0x41, 0x2e, 0x42,
	0x2e, 0x43, 0x12, 0x0c, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0xf2, 0x01, 0x03, 0x66, 0x6f, 0x6f,
	0x0a, 0x1c, 0x0a, 0x03, 0x62, 0x61, 0x72, 0x6a, 0x15, 0x0a, 0x05, 0x41, 0x2e, 0x42, 0x2e, 0x43,
	0x12, 0x0c, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0xf2, 0x01, 0x03, 0x62, 0x61, 0x72, 0x3a, 0x0f,
	...
	0x9a, 0x4a, 0x00, 0x42, 0x88, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x65, 0x64, 0x65,
...
var file_federation_federation_proto_goTypes = []interface{}{
	...
	(*A_B)(nil),                     // 8: federation.A.B
	(*A_B_C)(nil),                   // 9: federation.A.B.C
	nil,                             // 10: federation.User.ProfileEntry
	(*User_AttrA)(nil),              // 11: federation.User.AttrA
	(*User_AttrB)(nil),              // 12: federation.User.AttrB
	(*Item_Location)(nil),           // 13: federation.Item.Location
	(*Item_Location_AddrA)(nil),     // 14: federation.Item.Location.AddrA
	(*Item_Location_AddrB)(nil),     // 15: federation.Item.Location.AddrB
...
var file_federation_federation_proto_depIdxs = []int32{
	...
	8,  // 5: federation.A.b:type_name -> federation.A.B
	6,  // 6: federation.Post.user:type_name -> federation.User
	7,  // 7: federation.User.items:type_name -> federation.Item
	10, // 8: federation.User.profile:type_name -> federation.User.ProfileEntry
	11, // 9: federation.User.attr_a:type_name -> federation.User.AttrA
	12, // 10: federation.User.b:type_name -> federation.User.AttrB
	0,  // 11: federation.Item.type:type_name -> federation.Item.ItemType
	13, // 12: federation.Item.location:type_name -> federation.Item.Location
	9,  // 13: federation.A.B.foo:type_name -> federation.A.B.C
	9,  // 14: federation.A.B.bar:type_name -> federation.A.B.C
	16, // 15: federation.User.ProfileEntry.value:type_name -> google.protobuf.Any
	14, // 16: federation.Item.Location.addr_a:type_name -> federation.Item.Location.AddrA
	15, // 17: federation.Item.Location.b:type_name -> federation.Item.Location.AddrB
	2,  // 18: federation.FederationService.GetPost:input_type -> federation.GetPostRequest
	3,  // 19: federation.FederationService.GetPost:output_type -> federation.GetPostResponse
