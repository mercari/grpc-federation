...
var file_federation_federation_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x95, 0x10, 0x0a, 0x0f, 0x47,
	...
	0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x3a, 0x3f, 0x9a, 0x4a, 0x3c, 0x0a, 0x1c,
	0x0a, 0x03, 0x66, 0x6f, 0x6f, 0x6a, 0x15, 0x0a, 0x05, 0x41, 0x2e, 0x42, 0x2e, 0x43, 0x12, 0x0c,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0xf2, 0x01, 0x03, 0x66, 0x6f, 0x6f, 0x0a, 0x1c, 0x0a, 0x03,
	0x62, 0x61, 0x72, 0x6a, 0x15, 0x0a, 0x05, 0x41, 0x2e, 0x42, 0x2e, 0x43, 0x12, 0x0c, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0xf2, 0x01, 0x03, 0x62, 0x61, 0x72, 0x3a, 0x0f, 0x9a, 0x4a, 0x0c, 0x0a,
	...
	0x88, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x65, 0x64, 0x65, 0x72, 0x61, 0x74, 0x69,
...
var file_federation_federation_proto_depIdxs = []int32{
	...
	9,  // 6: federation.A.b:type_name -> federation.A.B
	6,  // 7: federation.Post.user:type_name -> federation.User
	7,  // 8: federation.User.items:type_name -> federation.Item
	11, // 9: federation.User.profile:type_name -> federation.User.ProfileEntry
	12, // 10: federation.User.attr_a:type_name -> federation.User.AttrA
	13, // 11: federation.User.b:type_name -> federation.User.AttrB
	0,  // 12: federation.Item.type:type_name -> federation.Item.ItemType
	14, // 13: federation.Item.location:type_name -> federation.Item.Location
	10, // 14: federation.A.B.foo:type_name -> federation.A.B.C
	10, // 15: federation.A.B.bar:type_name -> federation.A.B.C
	17, // 16: federation.User.ProfileEntry.value:type_name -> google.protobuf.Any
	15, // 17: federation.Item.Location.addr_a:type_name -> federation.Item.Location.AddrA
	16, // 18: federation.Item.Location.b:type_name -> federation.Item.Location.AddrB
	2,  // 19: federation.FederationService.GetPost:input_type -> federation.GetPostRequest
	3,  // 20: federation.FederationService.GetPost:output_type -> federation.GetPostResponse
