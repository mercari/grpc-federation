...
func (s *FederationService) resolve_Federation_A(ctx context.Context, req *Federation_AArgument) (*A, error) {
	...
	*/
	...
	if err := grpcfed.SetCELValue(ctx, value, "b", func(v *A_B) { ret.B = v }); err != nil {
		grpcfed.RecordErrorToSpan(ctx, err)
		return nil, err
	}
...
func (s *FederationService) resolve_Federation_A_B(ctx context.Context, req *Federation_A_BArgument) (*A_B, error) {
	...
	value := &localValueType{LocalValue: grpcfed.NewLocalValue(s.env, "grpc.federation.private.A_BArgument", req)}
	...
	*/
	...
	if err := grpcfed.SetCELValue(ctx, value, "foo", func(v *A_B_C) { ret.Foo = v }); err != nil {
		grpcfed.RecordErrorToSpan(ctx, err)
		return nil, err
	}
	// (grpc.federation.field).by = "bar"
	if err := grpcfed.SetCELValue(ctx, value, "bar", func(v *A_B_C) { ret.Bar = v }); err != nil {
		grpcfed.RecordErrorToSpan(ctx, err)
		return nil, err
	}
...
func (s *FederationService) resolve_Federation_A_B_C(ctx context.Context, req *Federation_A_B_CArgument) (*A_B_C, error) {
	...
	value := &localValueType{LocalValue: grpcfed.NewLocalValue(s.env, "grpc.federation.private.A_B_CArgument", req)}
	...
	if err := grpcfed.SetCELValue(ctx, value, "$.type", func(v string) { ret.Type = v }); err != nil {
		grpcfed.RecordErrorToSpan(ctx, err)
		return nil, err
	}
...
func (s *FederationService) resolve_Federation_GetPostResponse(ctx context.Context, req *Federation_GetPostResponseArgument) (*GetPostResponse, error) {
	...
	*/
	...
	if err := grpcfed.SetCELValue(ctx, value, "a", func(v *A) { ret.A = v }); err != nil {
		grpcfed.RecordErrorToSpan(ctx, err)
		return nil, err
	}
