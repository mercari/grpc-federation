...
func (s *FederationService) resolve_Org_Federation_GetPostResponse(ctx context.Context, req *Org_Federation_GetPostResponseArgument[*FederationServiceDependentClientSet]) (*GetPostResponse, error) {
	...
	var (
		...
		valuePost                *Post
		value_Def3ErrDetail0Msg0 *CustomMessage
		value_Def3ErrDetail0Msg1 *CustomMessage
	)
					...
					var details []proto.Message
					{
						...
						if !value.(bool) {
							...
							func() {
								...
								func() {
									msg, err := grpcfed.EvalCEL(s.env, "_def3_err_detail0_msg0", envOpts, evalValues, reflect.TypeOf((proto.Message)(nil)))
									if err != nil {
								...
								func() {
									msg, err := grpcfed.EvalCEL(s.env, "_def3_err_detail0_msg1", envOpts, evalValues, reflect.TypeOf((proto.Message)(nil)))
									if err != nil {
