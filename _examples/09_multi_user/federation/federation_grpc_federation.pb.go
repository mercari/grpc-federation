...
func (s *FederationService) resolve_Org_Federation_GetResponse(ctx context.Context, req *Org_Federation_GetResponseArgument[*FederationServiceDependentClientSet]) (*GetResponse, error) {
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		{
			valueIface, err, _ := sg.Do("uid_org.federation.UserID", func() (any, error) {
				valueMu.RLock()
		...
		*/
		{
			valueIface, err, _ := sg.Do("user_org.federation.User", func() (any, error) {
				valueMu.RLock()
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		{
			valueIface, err, _ := sg.Do("user2_org.federation.User", func() (any, error) {
				valueMu.RLock()
				args := &Org_Federation_UserArgument[*FederationServiceDependentClientSet]{
					Client: s.client,
				}
...
func (s *FederationService) resolve_Org_Federation_User(ctx context.Context, req *Org_Federation_UserArgument[*FederationServiceDependentClientSet]) (*User, error) {
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		{
			valueIface, err, _ := sg.Do("_org_federation_Sub_org.federation.Sub", func() (any, error) {
				valueMu.RLock()
			...
			valueMu.Lock()
			value_OrgFederation_Sub = value // { name: "_org_federation_Sub", message: "Sub" ... }
