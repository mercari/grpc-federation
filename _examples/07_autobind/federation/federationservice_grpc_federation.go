...
type Org_Federation_PostArgument struct {
	Client                 *FederationServiceDependencyServiceClient
	Id                     string
	OrgFederationUser      *User
	PostPostServiceGetPost *post.Post
}
...
func (s *FederationService) resolve_Org_Federation_GetPostResponse(ctx context.Context, req *Org_Federation_GetPostResponseArgument) (*GetPostResponse, error) {
	...
	*/
	...
	valueMu.Lock()
	valueOrgFederationPost = resPost // { name: "_org_federation_Post", message: "Post" ... }
	valueMu.Unlock()

	// assign named parameters to message arguments to pass to the custom resolver.
	req.OrgFederationPost = valueOrgFederationPost

	// create a message value to be returned.
	ret := &GetPostResponse{}

	// field binding section.
	ret.Id = valueOrgFederationPost.GetId()           // { name: "_org_federation_Post", autobind: true }
	ret.Title = valueOrgFederationPost.GetTitle()     // { name: "_org_federation_Post", autobind: true }
	ret.Content = valueOrgFederationPost.GetContent() // { name: "_org_federation_Post", autobind: true }
	ret.Uid = valueOrgFederationPost.GetUid()         // { name: "_org_federation_Post", autobind: true }
...
func (s *FederationService) resolve_Org_Federation_Post(ctx context.Context, req *Org_Federation_PostArgument) (*Post, error) {
	...
	var (
		sg                          singleflight.Group
		valueMu                     sync.RWMutex
		valueOrgFederationUser      *User
		valuePostPostServiceGetPost *post.Post
	)
	...
	*/
	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		/*
		   resolver: {
		     ...
		     response { name: "_post_PostService_GetPost", field: "post", autobind: true }
		   }
		*/
		...
		valueMu.Lock()
		valuePostPostServiceGetPost = resGetPostResponse.GetPost() // { name: "_post_PostService_GetPost", field: "post", autobind: true }
		valueMu.Unlock()
		return nil, nil
	})
	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		*/
		...
		valueMu.Lock()
		valueOrgFederationUser = resUser // { name: "_org_federation_User", message: "User" ... }
		valueMu.Unlock()
		return nil, nil
	})
	...
	// assign named parameters to message arguments to pass to the custom resolver.
	req.OrgFederationUser = valueOrgFederationUser
	req.PostPostServiceGetPost = valuePostPostServiceGetPost

	// create a message value to be returned.
	ret := &Post{}

	// field binding section.
	ret.Id = valuePostPostServiceGetPost.GetId()           // { name: "_post_PostService_GetPost", autobind: true }
	ret.Title = valuePostPostServiceGetPost.GetTitle()     // { name: "_post_PostService_GetPost", autobind: true }
	ret.Content = valuePostPostServiceGetPost.GetContent() // { name: "_post_PostService_GetPost", autobind: true }
	ret.Uid = valueOrgFederationUser.GetUid()              // { name: "_org_federation_User", autobind: true }
