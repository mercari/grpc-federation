...
type Org_Federation_PostArgument[T any] struct {
	...
	XPost_PostService_GetPost *post.Post
	Client                    T
}
...
func (s *FederationService) resolve_Org_Federation_GetPostResponse(ctx context.Context, req *Org_Federation_GetPostResponseArgument[*FederationServiceDependentClientSet]) (*GetPostResponse, error) {
	...
	*/
	{
		valueIface, err, _ := sg.Do("_org_federation_Post_org.federation.Post", func() (any, error) {
			valueMu.RLock()
		...
		valueMu.Lock()
		value_OrgFederation_Post = value // { name: "_org_federation_Post", message: "Post" ... }
	...
	ret.Uid = value_OrgFederation_Post.GetUid()         // { name: "_org_federation_Post", autobind: true }
...
func (s *FederationService) resolve_Org_Federation_Post(ctx context.Context, req *Org_Federation_PostArgument[*FederationServiceDependentClientSet]) (*Post, error) {
	...
	var (
		...
		value_Post_PostService_GetPost *post.Post
	)
	...
	*/
	...
	grpcfed.GoWithRecover(eg, func() (any, error) {
		...
		*/
		{
			valueIface, err, _ := sg.Do("_org_federation_User_org.federation.User", func() (any, error) {
				valueMu.RLock()
			...
			valueMu.Lock()
			value_OrgFederation_User = value // { name: "_org_federation_User", message: "User" ... }
		...
		*/
		{
			...
			valueMu.Lock()
			value_Post_PostService_GetPost = value.GetPost() // { name: "_post_PostService_GetPost", field: "post", autobind: true }
			envOpts = append(envOpts, cel.Variable("_post_PostService_GetPost", cel.ObjectType("post.Post")))
			evalValues["_post_PostService_GetPost"] = value_Post_PostService_GetPost
			valueMu.Unlock()
		}
		return nil, nil
	})
	...
	req.XPost_PostService_GetPost = value_Post_PostService_GetPost

	// create a message value to be returned.
	ret := &Post{}

	// field binding section.
	ret.Id = value_Post_PostService_GetPost.GetId()           // { name: "_post_PostService_GetPost", autobind: true }
	ret.Title = value_Post_PostService_GetPost.GetTitle()     // { name: "_post_PostService_GetPost", autobind: true }
	ret.Content = value_Post_PostService_GetPost.GetContent() // { name: "_post_PostService_GetPost", autobind: true }
