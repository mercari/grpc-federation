		...
		s.goWithRecover(eg, func() (interface{}, error) {
			...
			s.goWithRecover(eg, func() (interface{}, error) {
				...
				*/
				resAIface, err, _ := sg.Do("a_org.federation.A", func() (interface{}, error) {
					...
					valueMu.RUnlock()
					return s.resolve_Org_Federation_A(egCtx, args)
				})
				if err != nil {
					return nil, err
				}
				...
				*/
				resCIface, err, _ := sg.Do("c_org.federation.C", func() (interface{}, error) {
					...
					valueMu.RUnlock()
					return s.resolve_Org_Federation_C(egCtx, args)
				})
				if err != nil {
					return nil, err
				}
			...
			s.goWithRecover(eg, func() (interface{}, error) {
				...
				*/
				resBIface, err, _ := sg.Do("b_org.federation.B", func() (interface{}, error) {
					...
					valueMu.RUnlock()
					return s.resolve_Org_Federation_B(egCtx, args)
				})
				if err != nil {
					return nil, err
				}
				...
				*/
				resDIface, err, _ := sg.Do("d_org.federation.D", func() (interface{}, error) {
					...
					valueMu.RUnlock()
					return s.resolve_Org_Federation_D(egCtx, args)
				})
				if err != nil {
					return nil, err
				}
			...
			*/
			resEIface, err, _ := sg.Do("e_org.federation.E", func() (interface{}, error) {
				...
				valueMu.RUnlock()
				return s.resolve_Org_Federation_E(egCtx, args)
			})
			if err != nil {
				return nil, err
			}
		...
		s.goWithRecover(eg, func() (interface{}, error) {
			...
			*/
			resFIface, err, _ := sg.Do("f_org.federation.F", func() (interface{}, error) {
				...
				valueMu.RUnlock()
				return s.resolve_Org_Federation_F(egCtx, args)
			})
			if err != nil {
				return nil, err
			}
		...
		s.goWithRecover(eg, func() (interface{}, error) {
			...
			*/
			resGIface, err, _ := sg.Do("g_org.federation.G", func() (interface{}, error) {
				...
				valueMu.RUnlock()
				return s.resolve_Org_Federation_G(egCtx, args)
			})
			if err != nil {
				return nil, err
			}
