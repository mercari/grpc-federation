	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		*/
		resGetUserResponseIface, err, _ := sg.Do("org.user.UserService/GetUser", func() (interface{}, error) {
			...
			valueMu.RUnlock()
			return s.client.Org_User_UserServiceClient.GetUser(egCtx, args)
		})
		if err != nil {
			if err := s.errorHandler(egCtx, FederationService_DependentMethod_Org_User_UserService_GetUser, err); err != nil {
				return nil, err
			}
		}
