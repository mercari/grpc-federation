	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		*/
		resMIface, err, _ := sg.Do("m_org.federation.M", func() (interface{}, error) {
			...
			valueMu.RUnlock()
			return s.resolve_Org_Federation_M(egCtx, args)
		})
		if err != nil {
			return nil, err
		}
	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		*/
		resGetPostResponseIface, err, _ := sg.Do("org.post.PostService/GetPost", func() (interface{}, error) {
			...
			valueMu.RUnlock()
			return withTimeoutFederationService[post.GetPostResponse](egCtx, "org.post.PostService/GetPost", 10000000000 /* 10s */, func(ctx context.Context) (*post.GetPostResponse, error) {
				var b backoff.BackOff = backoff.NewConstantBackOff(2000000000 /* 2s */)
				b = backoff.WithMaxRetries(b, 3)
				b = backoff.WithContext(b, egCtx)
				return withRetryFederationService[post.GetPostResponse](b, func() (*post.GetPostResponse, error) {
					return s.client.Org_Post_PostServiceClient.GetPost(egCtx, args)
				})
			})
		})
		if err != nil {
			if err := s.errorHandler(egCtx, FederationService_DependentMethod_Org_Post_PostService_GetPost, err); err != nil {
				return nil, err
			}
		}
	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		*/
		if _, err, _ := sg.Do("z_org.federation.Z", func() (interface{}, error) {
			...
			valueMu.RUnlock()
			return s.resolve_Org_Federation_Z(egCtx, args)
		}); err != nil {
			return nil, err
		}
		valueMu.Lock()
