...
type Org_Federation_PostArgument struct {
	...
	OrgPostPostServiceGetPost *post.Post
}
...
func (s *FederationService) resolve_Org_Federation_Post(ctx context.Context, req *Org_Federation_PostArgument) (*Post, error) {
	...
	var (
		...
		valueOrgPostPostServiceGetPost *post.Post
	)
	...
	*/
	...
	s.goWithRecover(eg, func() (interface{}, error) {
		...
		*/
		...
		valueMu.Lock()
		valueOrgPostPostServiceGetPost = resGetPostResponse.GetPost() // { name: "_org_post_PostService_GetPost", field: "post", autobind: true }
		valueMu.Unlock()
		return nil, nil
	})
	...
	req.OrgPostPostServiceGetPost = valueOrgPostPostServiceGetPost

	// create a message value to be returned.
	ret := &Post{}

	// field binding section.
	ret.Id = valueOrgPostPostServiceGetPost.GetId()           // { name: "_org_post_PostService_GetPost", autobind: true }
	ret.Title = valueOrgPostPostServiceGetPost.GetTitle()     // { name: "_org_post_PostService_GetPost", autobind: true }
	ret.Content = valueOrgPostPostServiceGetPost.GetContent() // { name: "_org_post_PostService_GetPost", autobind: true }
